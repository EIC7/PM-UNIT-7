 ...
 *
 * DEFAULT VISIBLE: cuma beberapa titik pertama yang dinyalakan dari awal
 * (FEGT-P1..P3, LD-1..LD-2) supaya chart tidak langsung penuh 21/10 garis
 * sekaligus — user pilih sendiri titik mana yang mau dibandingkan lewat
 * checkbox di tag list (search box tersedia untuk cari titik tertentu).
 *
